      ...
      >
        <div className="w-full px-4 h-16 flex items-center justify-between gap-3">
          ...
          <div className="hidden md:flex items-center flex-shrink-0">
            <img src="/Home/images/logo-hojas.png" alt="Pacha Esperanza" style={{ height: '38px', width: 'auto', objectFit: 'contain' }} />
          </div>
          ...
          <div className="md:hidden flex items-center gap-2">
            ...
            <img src="/Home/images/logo-hojas.png" alt="Pacha Esperanza" style={{ height: '30px', width: 'auto', objectFit: 'contain' }} />
