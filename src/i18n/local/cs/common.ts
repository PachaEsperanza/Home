const cs = {
  ...
  // Hero
  hero_eyebrow: "Řemeslné výrobky · Cusco · Peru",
  hero_subtitle: "Toto nejsou jen řemeslné výrobky. Je to slib: už nikdy nebudou zapomenuti.",
  hero_desc: "Řemeslné výrobky z Cusca. Vytvořeny rodinami, které znovu uvěřily, a přeměněny v kousky čisté naděje. Z naší pobočky v České republice otevíráme náruč Evropě, abychom doručili tento ručně vyrobený poklad a zajistili, že každý kout kontinentu obdrží jejich jména, jejich boj a jejich příběhy neporušené.",
  ...
  manifesto_historia: "Existuje hluboké Peru, které bije silou v tichu svých hor. Tam, v údolích Cusco, zemědělci, na něž systém zapomněl, s oddaností pečují o své tradiční řemeslo a léčí zemi zasaženou opuštěním a nespravedlivými cenami. Tito producenti jsou duší odporu; muži a venkovské rodiny, kteří povstali s ryzí odvahou proti prázdným slibům a překupníkům, kteří je vykořisťovali. Proti větru a bez státu, který by je podpořil, se rozhodli nevzdat, proměnili bolest v hrdost a zvolili důstojnost jako jedinou cestu k ochraně svých kořenů. COMPARTO_TU_ESPERANZA je objetí, které spojuje tuto neúnavnou odvahu s tebou. Vytváříme tento most proto, aby každá unce čokolády, kterou na druhé straně oceánu ochutnáš, přestala být pouhým potěšením a stala se objetím na oplátku — skutečnou investicí do životů těch, kteří dávají vše pro svou zemi. Vybrat si tyto řemeslné výrobky není jen otázkou dobrého vkusu; je to pohled jim do očí, uznání jejich hodnoty a závazek k obnově posvátného odkazu, který se oni navzdory všemu rozhodli zachránit.",
  ...
  // Footer
  footer_tagline: "Řemeslné výrobky z Cusca,\nPeru.",
  ...
  cart_whatsapp_message: 'Dobrý den, mám zájem o řemeslné výrobky HOLZEN. Moje objednávka:\n{{lines}}\nOdhadovaný celkový součet: ${{total}}',
  ...
  historia_cards3: [
    ...
    "Dnes se tato cesta již začala otevírat. Již existují kontakty a klienti v Evropě, kteří mají zájem o vysoce kvalitní peruánské řemeslné výrobky. A díky naší přítomnosti v České republice můžeme zajistit procesy, kvalitu a distribuci do různých zemí Evropy.",
  ...
  unidos_cards: [
    "Chci, abychom společně vybudovali něco mnohem většího než firmu. Chci, abychom — spolu s vámi, našimi řemeslníky z Cusca — se stali jednou velkou rodinou. Rodinou spojenou prací, respektem, důvěrou a snem přinést světu jeden z nejvzácnějších pokladů naší země: peruánské řemeslné výrobky.",
    "Sním o dni, kdy naše řemeslné výrobky budou mezinárodně uznávány nejen pro svou mimořádnou kvalitu, ale také pro své nesrovnatelné aroma, jedinečný původ a lidský příběh za každou sklizní. Ale především sním o tom, aby každý z vás byl uznán. Za roky úsilí. Za lásku, kterou vkládáte do každé rostliny. Za ranní hodiny práce. Za tiché odhodlání, které tak dlouho nikdo neviděl ani neocenил jak si zasluhovalo.",
  ...
  unidos_frase: "Nejlepší řemeslný výrobek vzniká, když půda, srdce a naděje pracují společně a stanou se jednou velkou rodinou.",
};
