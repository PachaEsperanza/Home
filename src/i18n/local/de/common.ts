const de = {
  ...
  // Hero
  hero_eyebrow: "Kunsthandwerk · Cusco · Peru",
  hero_subtitle: "Das ist nicht nur Kunsthandwerk. Es ist ein Versprechen: sie werden nie vergessen.",
  hero_desc: "Kunsthandwerk aus Cusco. Geschaffen von Familien, die wieder zu glauben begannen, und in Stücke reiner Hoffnung verwandelt. Von unserer Niederlassung in der Tschechischen Republik öffnen wir Europa die Arme, um diesen handgefertigten Schatz zu liefern und sicherzustellen, dass jeder Winkel des Kontinents ihre Namen, ihren Kampf und ihre Geschichten unversehrt erhält.",
  ...
  // Footer
  footer_tagline: "Kunsthandwerk aus Cusco,\nPeru.",
  ...
  cart_whatsapp_message: 'Hallo, ich interessiere mich für HOLZEN Kunsthandwerk. Meine Bestellung:\n{{lines}}\nGeschätzter Gesamtbetrag: ${{total}}',
  ...
  historia_cards3: [
    "Es entstand, weil ich auch etwas Grundlegendes verstand: Helfen bedeutet nicht, zu verschenken. Helfen bedeutet, nachhaltige und echte Chancen zu schaffen. Es bedeutet, der Welt den wahren Wert unserer Bauern, unseres Kunsthandwerks, unserer Kultur und der außergewöhnlichen Arbeit in Peru zu zeigen.",
    ...
    "Heute hat sich dieser Weg bereits zu öffnen begonnen. Es gibt bereits Kontakte und Kunden in Europa, die an hochwertigem peruanischen Kunsthandwerk interessiert sind. Und dank unserer Präsenz in der Tschechischen Republik können wir Prozesse, Qualität und Distribution in verschiedene europäische Länder sicherstellen.",
  ...
  unidos_cards: [
    "Ich möchte, dass wir gemeinsam etwas aufbauen, das viel größer ist als ein Unternehmen. Ich möchte, dass wir — zusammen mit Ihnen, unseren Kunsthandwerkern aus Cusco — zu einer großen Familie werden. Eine Familie, die durch Arbeit, Respekt, Vertrauen und den Traum verbunden ist, einen der wertvollsten Schätze unseres Landes in die Welt zu bringen: peruanisches Kunsthandwerk.",
    "Ich träume von dem Tag, an dem unser Kunsthandwerk international anerkannt wird — nicht nur für seine außergewöhnliche Qualität, sondern auch für sein unvergleichliches Aroma, seinen einzigartigen Ursprung und die menschliche Geschichte hinter jeder Ernte. Vor allem aber träume ich davon, dass jeder von Ihnen anerkannt wird. Für Ihre Jahre des Einsatzes. Für die Liebe, die Sie in jede Pflanze stecken. Für die frühen Morgenstunden der Arbeit. Für die stille Hingabe, die so lange niemand sah oder schätzte.",
    "Denn hinter dem besten Kunsthandwerk steckt nicht nur fruchtbare Erde. Es gibt Familien. Es gibt Opfer. Es gibt Geschichte. Es gibt Herz. Und das ist es, was ich der Welt zeigen möchte.",
    ...
    "Ich möchte, dass dieses Projekt zu einer echten Chance wird, Leben zu verändern, Türen zu öffnen und zu beweisen, dass aus den Bergen und Gemeinschaften Cuscos eines der besten Kunsthandwerke der Welt entstehen kann. Das ist nicht nur Kunsthandwerk-Export. Das bedeutet, unsere Geschichte, unsere Kultur und unsere Identität in die ganze Welt zu tragen. Und ich möchte es gemeinsam mit Ihnen tun. Denn ich bin von einer Sache überzeugt: Wenn Menschen als große Familie zusammenarbeiten, mit Zweck, Würde und Herz… können sie etwas wirklich"
  ],
  unidos_press: "Pfeil drücken um weiterzulesen",
  unidos_frase: "Das beste Kunsthandwerk entsteht, wenn Erde, Herz und Hoffnung zusammenarbeiten und zu einer großen Familie werden.",
};
